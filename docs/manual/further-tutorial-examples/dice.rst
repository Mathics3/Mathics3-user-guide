...
>>> Dice[1]
    ...
    =
.. image:: asy_Manual_Further_Tutorial_Examples_Dice_84nz09ef.png
    :align: center
...
>>> Dice[]
    ...
    =
.. image:: asy_Manual_Further_Tutorial_Examples_Dice_96fg1gy7.png
    :align: center
...
>>> Dice[1, 6, 4, 4]
    ...
    =
.. image:: eq_Manual_Further Tutorial Examples_Dice_zcw41ivs.png
    :align: center
...
>>> Dice[1, 5] + Dice[3, 2] + Dice[4]
    ...
    =
.. image:: eq_Manual_Further Tutorial Examples_Dice_syia18uv.png
    :align: center
...
>>> Table[{Dice[Sequence @@ d], DiceSum @ Dice[Sequence @@ d]}, {d, {{1, 2}, {2, 2}, {2, 6}}}] // TableForm
    ...
    =
.. image:: eq_Manual_Further Tutorial Examples_Dice_eroks2jv.png
    :align: center
