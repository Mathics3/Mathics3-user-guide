...
>>> Graphics[{Circle[{0, 0}, 1]}]
    ...
    =
.. image:: asy_Manual_Language_Tutorial_Graphics_Introduction_Examples_lah5y911.png
    :align: center
...
>>> Graphics[{Line[{{0, 0}, {0, 1}, {1, 1}, {1, -1}}], Rectangle[{0, 0}, {-1, -1}]}]
    ...
    =
.. image:: asy_Manual_Language_Tutorial_Graphics_Introduction_Examples_tl_h_gy2.png
    :align: center
...
>>> Graphics[{Red, Disk[]}]
    ...
    =
.. image:: asy_Manual_Language_Tutorial_Graphics_Introduction_Examples_06ftbga_.png
    :align: center
...
>>> Graphics[Table[{Hue[h, s], Disk[{12h, 8s}]}, {h, 0, 1, 1/6}, {s, 0, 1, 1/4}]]
    ...
    =
.. image:: asy_Manual_Language_Tutorial_Graphics_Introduction_Examples_f937xs97.png
    :align: center
...
>>> Graphics[{Lighter[Red], Disk[]}]
    ...
    =
.. image:: asy_Manual_Language_Tutorial_Graphics_Introduction_Examples_9zt3wuhl.png
    :align: center
