...
>>> $PrintForms
    ...
    =
:math:`\left\{\text{MathMLForm},\text{SympyForm},\text{TraditionalForm},\text{InputForm},\text{PythonForm},\text{FullForm},\text{StandardForm},\text{TeXForm},\text{OutputForm},\text{MyForm}\right\}`
