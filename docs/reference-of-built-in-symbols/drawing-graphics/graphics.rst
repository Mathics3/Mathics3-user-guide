...
>>> Graphics[{Blue, Line[{{0,0}, {1,1}}]}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Graphics_w2qc1h_9.png
    :align: center
...
>>> Graphics[{Rectangle[{1, 1}]}, Axes -> True, PlotRange -> {{-2, 1.5}, {-1, 1.5}}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Graphics_uifdushn.png
    :align: center
...
>>> Graphics[{Rectangle[],Red,Disk[{1,0}]},PlotRange->{{0,1},{0,1}}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Graphics_yqvcxzmy.png
    :align: center
...
>>> Graphics[{Green, Disk[]}, Background->RGBColor[.6, .7, 1.]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Graphics_uk8b4jes.png
    :align: center
