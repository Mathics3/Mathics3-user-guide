...
>>> Graphics[Point[{0, 0}]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Point_w9mr4jii.png
    :align: center
...
>>> Graphics[Point[Table[{Sin[t], Cos[t]}, {t, 0, 2. Pi, Pi / 15.}]]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_Point_9j0ulddy.png
    :align: center
