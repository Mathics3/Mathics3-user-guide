...
>>> Graphics[RegularPolygon[5]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_RegularPolygon_sie5cmkc.png
    :align: center
...
>>> Graphics[{Yellow, Rectangle[], Orange, RegularPolygon[{1, 1}, {0.25, 0}, 3]}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Drawing_Graphics_RegularPolygon_jfmw_kyl.png
    :align: center
