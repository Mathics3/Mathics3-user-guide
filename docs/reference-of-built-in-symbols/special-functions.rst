...
One good source is `The NIST Digital Library of Mathematical Functions <https://dlmf.nist.gov/>`_.
...
.. toctree::
    ...
    special-functions/bessel-and-related-functions.rst
    special-functions/elliptic-integrals.rst
    special-functions/error-function-and-related-functions.rst
    special-functions/exponential-integral-and-special-functions.rst
    special-functions/gamma-and-related-functions.rst
    special-functions/orthogonal-polynomials.rst
    special-functions/zeta-functions-and-polylogarithms.rst
