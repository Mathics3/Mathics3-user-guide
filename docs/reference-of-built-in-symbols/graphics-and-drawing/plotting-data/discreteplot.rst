...
>>> DiscretePlot[PrimePi[k], {k, 1, 100}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_DiscretePlot_71goy_s2.png
    :align: center
...
>>> DiscretePlot[2.5 Sqrt[k], {k, 100}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_DiscretePlot_3yryv6_v.png
    :align: center
...
>>> DiscretePlot[{Sin[Pi x/20], Cos[Pi x/20]}, {x, 0, 40}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_DiscretePlot_g6zi6wxz.png
    :align: center
