...
>>> Graphics3D[{Arrow[{{0,0,0},{1,0,1},{0,-1,0},{1,1,1}}]}, Background -> Red]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_Background_qrsnet0x.png
    :align: center
...
>>> Plot[{Sin[x], Cos[x], x / 3}, {x, -Pi, Pi}, Background -> RGBColor[0.5, .5, .5, 0.1]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_Background_w97o9ddv.png
    :align: center
