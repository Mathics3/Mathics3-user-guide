...
>>> Graphics3D[Cuboid[{0, 0, 1}]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_Cuboid_0_f5m_us.png
    :align: center
...
>>> Graphics3D[{Red, Cuboid[{{0, 0, 0}, {1, 1, 0.5}}], Blue, Cuboid[{{0.25, 0.25, 0.5}, {0.75, 0.75, 1}}]}]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_Cuboid_bfx8cl8g.png
    :align: center
...
>>> Graphics[Cuboid[{0, 0}]]
    ...
    =
.. image:: asy_Reference_of_Built-in_Symbols_Graphics_and_Drawing_Cuboid_xa7xdpz4.png
    :align: center
